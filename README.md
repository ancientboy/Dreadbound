...
项目处于**内容扩展原型阶段**。当前包含覆盖整个副本的迷雾与地图、近战/手枪切换、弹药资源、The Patient 与 The Crawler、绷带和回响碎片、手机触控，以及记录、供电和撤离任务路线；仍不包含正式美术和完整装备系统。
...
7. **风险事件（下一步）**：加入两种随机事件和继续探索/立即撤离的奖励选择。
8. **表现与平衡**：统一像素素材、灯光和音效、终端风格 UI、永久强化及 Web 性能优化。
