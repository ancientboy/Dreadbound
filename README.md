...
安装 Godot 4 后，在 Project Manager 中导入 `project.godot` 并按 **F5**，或运行 `godot --path .`。电脑使用 WASD/方向键移动、空格/J 攻击、R/Tab 切换武器、E 交互、Q 使用绷带/镇静剂；手机和平板使用左侧摇杆及右侧攻击、切换、交互、道具按钮。建议横屏游玩。
