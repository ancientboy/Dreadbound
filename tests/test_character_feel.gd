...
func _run_test() -> void:
	...
	assert(weapon_vfx.melee_uses_crescent(&"sword"))
	assert(weapon_vfx.melee_uses_crescent(&"crowbar"))
	assert(weapon_vfx.melee_uses_crescent(&"insulated_crowbar"))
	assert(weapon_vfx.melee_uses_crescent(&"volatile_edge"))
	assert(not weapon_vfx.melee_uses_crescent(&"echo_edge"))
