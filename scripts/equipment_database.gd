...
const ITEMS := {
	...
	"nullpoint_sidearm": {"name": "零点标记枪", "quality": "异常", "quality_rank": 3, "slot": "weapon", "rating": 186, "trait": "weakpoint_mark", "tags": ["weakpoint", "precision"], "description": "远距命中积累弱点标记 · 手枪伤害 +10 · 生命上限 -4", "ranged_damage": 10, "max_health": -4},
	"siege_core": {"name": "围城火力核心", "quality": "异常", "quality_rank": 3, "slot": "weapon", "rating": 190, "trait": "heavy_suppression", "tags": ["heavy", "suppression"], "description": "霰弹压制范围扩大 · 霰弹伤害 +11 · 移速 -5", "shotgun_damage": 11, "movement_speed": -5.0},
	"volatile_edge": {"name": "失控回响刃", "quality": "异常", "quality_rank": 3, "slot": "weapon", "rating": 188, "trait": "anomaly_edge", "tags": ["anomaly", "melee"], "description": "近战伤害 +13 · 生命上限 -9", "melee_damage": 13, "max_health": -9},
